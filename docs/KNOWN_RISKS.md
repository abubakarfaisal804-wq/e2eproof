...
| Open CodeQL high alert | Alert #1 traces `trusted_key_match` into shared JSON stdout | CodeQL runs on PRs, pushes, and weekly | Fix narrowly; do not suppress the shared sink |
